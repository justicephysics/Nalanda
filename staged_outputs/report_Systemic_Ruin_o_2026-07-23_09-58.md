...
```mermaid
graph TD
    A[Public Primary System Decay] -->|ASER Deficits & Multi-Grade Classrooms| B[Parental Flight to Low-Fee Private / Dummy Schools]
    B --> C[Entry into Hyper-Competitive Elimination Matrix]
    C --> D{Selection Gatekeeping}
    D -->|Top 1.5% to 3.5%| E[Tier-1 Public Seats / Premier Elite]
    D -->|96.5% to 98.5% Rejection| F[The Triad of Educational Extortion]
    F -->|Extractive Coaching Fees| G[Household Debt & Financial Exhaustion]
    F -->|Paper Leaks & Corrupt Testing| H[Severe Psychological Trauma & Suicide Risk]
    F -->|Substandard Private Degree Mills| I[Degree Acquisition Without Capability]
    I --> J[Cattle Fodder Equilibrium: Gig Work & Call Centers]
    G --> J
    H --> K[Mass Youth Resistance & Social Unrest]
```
