...
```mermaid
graph TD
    A[Raw Human Matrix / Youth Enrollees] --> B[Foundational Public Decay & Artificial Scarcity]
    B --> C{Bottleneck Filter}
    C -->|Top 1.5% to 3.5%| D[Elite Skill Acquisition & Capital Accumulation]
    C -->|Bottom 96.5% to 98.5%| E[Degree Mills & Extortionate Coaching Mafia]
    E --> F[Unemployable Gig Workforce & Debt Traps]
    F --> G[Systemic Entropic Decay & Youth Resistance]
```
