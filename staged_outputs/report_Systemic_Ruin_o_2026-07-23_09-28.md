...
```mermaid
graph TD
    A[Primary & Secondary Foundational Decay] -->|50%+ Illiteracy in Grade 5| B[Hyper-Inflated Elimination Bottleneck]
    B -->|UPSC: 99.92% Rejection, JEE: 98.80%| C{Path Selection}
    
    C -->|Household Capital Extraction| D[Test-Prep & Coaching Mafia]
    C -->|Capital Extraction / High Debt| E[Private Degree Mills / Capitation Fee]
    
    D -->|12-14 Hr Rote Factories| F[Psychological Toll & NCRB Suicides]
    E -->|Substandard Instruction| G[Cattle Fodder Paradox: 80-85% Unemployable]
    
    F --> H[Civilizational Entropy Increase]
    G --> H
    
    H -->|Sovereignty Triad Collapse| I[TI Coupling Value = 0.084672]
```
