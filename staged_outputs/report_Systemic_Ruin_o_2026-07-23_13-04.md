...
```mermaid
flowchart TD
    A[Public School Decay & Teacher Vacancies] --> B[Parental Flight to Private/Coaching Systems]
    B --> C[Financial Extraction: ₹1.0L Cr to ₹3.5L Cr Coaching Industry]
    C --> D[12-14 Hour Rote Coaching & Dummy Schools]
    D --> E{Hyper-Elimination Lottery}
    E -- Top 1.5% --> F[Elite Public Seats / Tier-1 Institutions]
    E -- Remaining 98.5% --> G[Private Degree Mills / High Capitation Fees]
    G --> H[Debt Accumulation & Unemployability 80-85%]
    H --> I[Gig Work / Low-Wage Subordination]
    I --> J[Civilizational Entropy Accumulation]
    F --> K[Concentrated Elite Class Generation]
```
