...
```mermaid
graph TD
    A[Raw Youth Matrix: 100% Potential] --> B{Primary System Decay}
    B -->|ASER Deficit: >50% Illiteracy| C[Early Cognitive Paralysis]
    B -->|Functional Literacy| D[Elimination Bottleneck: IIT/NEET/CUET]
    
    D -->|Top 2% - 3.5%| E[Tier-1 Industry Grade Seats]
    D -->|Rejected 96.5%| F[Degree Mill Trap / Coaching Loop]
    
    E --> G[Generated Elite Class: Technical & Admin Power]
    
    F -->|Capital Extraction| H[Coaching Mafia / Private Capitation Debt]
    H --> I[Unemployable Engineering Graduates: 80-85%]
    I --> J[Underprivileged Working Majority: Gig Work, Delivery, Call Centers]
    
    G -.->|Sustains Systemic Gatekeeping| D
    J -.->|System Failure / Resistance| K[Civilizational Phase Transition]
```
