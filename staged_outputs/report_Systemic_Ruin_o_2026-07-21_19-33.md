...
```mermaid
graph TD
    A[Family Household Savings] --> B[Axis 1: Coaching/Test-Prep Mafia]
    A --> C[Axis 2: Private Capitation Fees]
    B --> D[12-14 Hour Rote Factories]
    B --> E[Dummy Schools]
    C --> F[₹50L - ₹1.5Cr MBBS Private Seats]
    C --> G[₹10L - ₹25L Substandard Eng/MBA Degrees]
    D --> H[Severe Mental & Financial Exhaustion]
    F --> H
    G --> H
```
