...
```mermaid
graph TD
    A[Total Student Applicant Base: 40 Million+] --> B{Hyper-Elimination Bottleneck}
    B -->|98.5% to 99.8% Percentile Required| C[Top Public College Seats: < 1.5%]
    B -->|Eliminated Majority: 98.5%+| D[Forced Extraction Pipelines]
    D --> E[Coaching Mafia: ₹1.0L Cr - ₹3.5L Cr]
    D --> F[Private Degree Mills: ₹10L - ₹1.5 Cr]
    E --> G[Gig Work / Unemployable Graduates]
    F --> G
```
