...
```mermaid
flowchart TD
    A[Public Seat Artificial Scarcity] --> B[Test-Prep Shadow Economy]
    A --> C[Private Capitation Fee Extraction]
    B --> D[Dummy School Factories & Rote Gaming]
    C --> E[Debt Accumulation for Degree Mills]
    D --> F[Cognitive Noise & Skill Invalidation]
    E --> F
    F --> G[Low-Wage Gig Work / Unemployable Base]
    G --> H[Civilizational Entropy Expansion]
    H --> A
```
