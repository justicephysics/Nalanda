...
```mermaid
flowchart TD
    A[Primary Education Deficits] --> B[Rote Learning & Elimination Focus]
    B --> C{Coaching Matrix Gateway}
    C -->|Exorbitant Capital Extracted| D[Hyper-Inflated Elimination Lottery]
    C -->|Financial Exclusion| E[Substandard Private Degree Mills]
    D -->|98%+ Rejection Rate| F[Psychological Despair & Suicides]
    D -->|Paper Leaks & Scandals| F
    E -->|Unemployable Output| G[Low-Wage Gig Work Economy]
    F --> H[Civilizational Entropy Expansion]
    G --> H
```
