...
```mermaid
graph TD
    A[Foundational Decay & Primary Schooling Deficits] --> B[Public University Capacity Bottleneck <1.5%]
    B --> C[Hyper-Competitive Elimination Matrix]
    C --> D1[Coaching Mafia Extortion: ₹1.0L-3.5L Cr]
    C --> D2[Paper Leaks & Institutional Integrity Failure]
    C --> D3[96.5% Degree Mills: Cattle Fodder Paradox]
    D1 --> E[Youth Psychological & Mortalities: >13k Suicides/Yr]
    D2 --> F[Systemic Inversion & Street Mobilization]
    D3 --> G[Economic Independence Collapse: EI -> 0.08]
